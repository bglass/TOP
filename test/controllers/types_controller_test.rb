...
class TypesControllerTest < ActionController::TestCase
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post :create, type: { children: @type.children, extras: @type.extras, fields: @type.fields, name: @type.name, priority: @type.priority, relations: @type.relations }
    end
  ...
  test "should update type" do
    patch :update, id: @type, type: { children: @type.children, extras: @type.extras, fields: @type.fields, name: @type.name, priority: @type.priority, relations: @type.relations }
    assert_redirected_to type_path(assigns(:type))
  end
